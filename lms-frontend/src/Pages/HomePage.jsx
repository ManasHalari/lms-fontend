...
function HomePage() {
  return (
    ...
    <HomeLayout>
         <div className="flex items-center justify-center pt-10 mx-10 my-5 text-white gap-10 h-[90vh]">
                <div className="space-y-6 w-1/2 ">
                    ...
                    <Link to="/contacts">
                        <button className="bg-black mx-5 px-5 py-3 rounded-md font-semibold cursor-pointer hover:bg-gray-600 transition-all ease-in-out duration-300">
                            Explore Courses
                        </button>
                    </Link>
                    </div>
